...
/**
 * Replace these URLs with your actual female 320×320 images.
 */
...
const Register2 = () => {
    ...
    // When generation completes, mount the popup (which will slide up)
    useEffect(() => {
        if (isGenerated) {
    ...
    return (
        <main className=" relative flex flex-col items-center p-4 md:p-6 bg-black gap-16">
            ...
            <div className={`flex flex-col items-center gap-4 transition-opacity duration-500 ${currentStep >= 1 ? 'opacity-100' : 'opacity-40'}`}>
                ...
                <div className="aspect-square min-w-80 border border-main rounded-2xl p-10 relative bg-black flex flex-col justify-center items-center">
                    ...
                    />
                    <MainButton className="z-1" onClick={() => setCurrentStep(2)}>Scan your face</MainButton>
                </div>
            </div>
            ...
            <div className={`flex flex-col items-center gap-4 transition-opacity duration-500 ${currentStep >= 2 ? 'opacity-100' : 'opacity-40'}`}>
                ...
                <MainButton variant="solid" className="" onClick={() => setCurrentStep(3)}>Pay</MainButton>
                        ...
                        {stylesToShow.map((item) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={` relative w-full h-full cursor-pointer overflow-hidden rounded-lg  transition ${isSelected
                                        ? "ring-4 ring-[#FFD789]"
       ...
       */}
            {isGenerated && (
                <div className="fixed inset-0 z-50 overflow-hidden">
                    ...
                    {/* slide-up container */}
                    <div
                        className={`absolute bottom-0 left-0 w-full h-full bg-black flex flex-col items-center justify-center transform transition-transform duration-500 gap-4 ${showPopup ? "translate-y-0" : "translate-y-full"
                            }`}
                    >
                        <h1 className=" ">
                            Your Passport
                        ...
                        {selectedStyle && (
                            <div className="flex flex-col items-center w-auto h-auto overflow-hidden ">
                                <Passport nickname="Test" gender="male" avatarUrl="/default-avatar.svg" />
                            </div>
                        )}
