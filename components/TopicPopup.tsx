  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 w-11/12 max-w-3xl -translate-x-1/2 -translate-y-1/2 rounded-xl bg-black border border-main p-6 flex flex-col gap-6 max-h-[85vh] overflow-y-auto no-scrollbar">
          {/* Header */}
